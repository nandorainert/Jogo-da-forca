...
int main(){
    ...
    char l1,l2,l3,l4,l5,l6, tentativa, t1 = '_',t2 = '_',t3 = '_',t4 = '_',t5 = '_',t6 = '_';//Variáveis que será guardada as palavras
    ...
    do{//Laço de repetição para menu ficar repetindo até que a escolha serja diferente de 3, o 3 é a opção de FIM.
        ...
        switch(escolha){//Switch para verificar qual a escolha que usuário fez entre 1 e 2 caso não tenha sido o 3.
            ...
            do{//Inicia um laço de repetição para que seja jogado, repete até 10 vezes.
                ...
                if (t1 != '_' and t2 != '_' and t3 != '_' and t4 != '_' and t5 != '_' and t6 != '_' and cont_tentativa <= 11){//casp todas as variáveis de letras tentadas seja diferente de "_" significa que a pessoa acertou a palavra.
            ...
            if (t1 == '_' or t2 == '_' or t3 == '_' or t4 == '_' or t5 == '_' or t6 == '_'){//Caso uma das letras de tentativas ainda estejam com o valor inicial, é verdadeiro.
            ...
            t1 = '_',t2 = '_',t3 = '_',t4 = '_',t5 = '_',t6 = '_';//Reseta as variáveis de letras de tentativa.
